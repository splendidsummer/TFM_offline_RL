...
class IQLConfig(LearnableConfig):
    ...
    .. math::make_optimizer_field

        L_V(\psi) = \mathbb{AE}_{(s, a) \sim D}
...
class IQL(QLearningAlgoBase[IQLImpl, IQLConfig]):
    def inner_create_impl(
        ...
        # policy = create_equivariant_normal_policy(
        #     observation_shape,
        #     action_size,
        #     self._config.actor_encoder_factory,
        #     min_logstd=-5.0,
        ...
        # q_funcs, q_func_forwarder = create_equivariant_continuous_q_function(
        #     observation_shape,
        #     action_size,
        #     self._config.critic_encoder_factory,
        #     MeanQFunctionFactory(),
        ...
        # targ_q_funcs, targ_q_func_forwarder = create_equivariant_continuous_q_function(
        #     observation_shape,
        #     action_size,
        #     self._config.critic_encoder_factory,
        #     MeanQFunctionFactory(),
        ...
        # value_func = create_equivariant_value_function(
        #     observation_shape,
        #     self._config.value_encoder_factory,
        #     device=self._device,
        # )
